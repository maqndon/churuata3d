            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <BreezeNavLink :href="route('companies.index')" :active="route().current('employees.index')">
                                    Companies
                                </BreezeNavLink>
                            </div>
                        </div>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            <div class="ml-3 relative"> 
                                <BreezeDropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        <BreezeDropdownLink :href="route('users.edit', $page.props.auth.user.id)" method="get" as="button">
                                            My Profile
                                        </BreezeDropdownLink>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <BreezeResponsiveNavLink :href="route('companies.index')" :active="route().current('employees.index')">
                            Companies
                        </BreezeResponsiveNavLink>
                    </div>
